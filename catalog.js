...
export const PRODUCTS = [
  ...
  {
    slug: "christ-is-king-cropped-hoodie",
    name: "Christ Is King",
    subtitle: "Graphic cropped pullover hoodie \u00b7 Camo sleeves",
    price_usd: 10,
    sizes: ["S", "M", "L", "XL"],
    colors: [
      {
        ...
        alt: "Christ Is King cropped pullover hoodie, bone colorway, back print",
      },
      {
        key: "black",
        label: "Black",
        image: "/img/crucifix-black.jpg",
        alt: "Christ Is King cropped pullover hoodie, black colorway, back print",
      },
    ],
  },
];
